...
--%>
<jsp:directive.include file="includes/ucctop.jsp" />
    ...
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
        ...
        <section class="row">
            ...
            <table>
                <tr>
                    <td>
                        <form:input cssClass="required" cssErrorClass="error" id="authcode" size="10" tabindex="3" path="authcode"  accesskey="${authcodeAccessKey}" htmlEscape="true" autocomplete="off" />
                    </td>
